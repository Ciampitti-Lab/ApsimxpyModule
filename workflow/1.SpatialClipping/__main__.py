...
gdb_path="/workspace/workflow/1.SpatialClipping/FIELDS1724.gdb"
...
usa = gpd.read_file("/workspace/workflow/1.SpatialClipping/US_States/US_States.shp")
...
aoi_fields.to_file("/workspace/workflow/2.GridSampling/aoi_fields.geojson",driver="GeoJSON")
