...
aoi_fields=gpd.read_file("/workspace/workflow/2.GridSampling/aoi_fields.geojson")
...
field_final_sample.to_file("/workspace/workflow/3.AgroDataExtraction/field_final_sample.geojson",driver="GeoJSON")
