...
for id,row in fields.iloc[0:10,:].iterrows():
    if row['id_within_cell']%2==0:
        ...
        os.makedirs(f"/workspace/workflow/5.RunSimulations/field_{row['id_cell']}_{row['id_within_cell']}")
        # Setting the weather
        ...
        shutil.copy("/workspace/CornSoybean.apsimx",f"/workspace/workflow/5.RunSimulations/field_{row['id_cell']}_{row['id_within_cell']}/SoybeanCorn_{row['id_cell']}_{row['id_within_cell']}.apsimx")
        ...
        soil1.set_soil_saxton(soil)
        # Saving file in folder
        shutil.copy("/workspace/SoybeanCorn.apsimx",f"/workspace/workflow/5.RunSimulations/field_{row['id_cell']}_{row['id_within_cell']}/CornSoybean_{row['id_cell']}_{row['id_within_cell']}.apsimx")
        # Counting simulations
        count+=1
