...
gtd1=pd.read_csv("/workspace/workflow/_9GTDpreparation/MasterDbase_NR_Dbase_forRstudio_0504.csv",encoding="latin")
# Filtering rows
gtd1 = gtd1[gtd1['Manure']=='no'] # No Manure
gtd1 = gtd1[gtd1['Irrig']=='no'] # No Irrigation
gtd1 = gtd1[gtd1['Prev crop']=='Soy'] # Only Soybean as a Prep Crop
...
# Selecting Columns
gtd1=gtd1[['Year','CRD','County','a','b','c']]


# Nitrogen dosis
nitro = np.random.uniform(0, 267.66, size=13)


gtd1['id_trial'] = gtd1.index + 1
